...
/* PHY Address — legacy CubeMX placeholder, not used by this project.
 * This project uses LAN8720A; PHY address is defined in lan8720.h as
 * LAN8720_PHY_ADDRESS (default 0x01, set by PHYAD0 hardware strap). */
